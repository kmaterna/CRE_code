...
def CRE_post_analysis(MyParams,output_dir):
	...
	# gmt_plotting.main_program(MyParams.Network_repeaters_list, MyParams.families_summaries, MyParams.station_locations);
	...
	# view_families.view_families(MyParams.time_window,MyParams.families_list,MyParams.families_summaries,MyParams.station_locations,output_dir,families=[-1]);	
	return;
...
def cleaning_up(output_dir):
	...
	move_files_matching('*.txt',output_dir);
