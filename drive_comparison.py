...
mapping_code='/work/seismo85/kmaterna/CRE_detection/Mapping_files/Mendocino_mapping_code'  # you will want to change this if you're interested in a different place, like Mendocino, Anza, etc. 
