...
def make_coh_snr_plot(output_dir,event1,event2,waveform_file_name,coh_file_name,inst_freq,min_freq,max_freq,snr_cutoff,show_overlay,pretty_plot):
	...
	if pretty_plot:
		...
		axarr[4].set_title('SNR. D1='+str(dist1)+', M1='+str(mag1)+'; D2='+str(dist2)+', M2='+str(mag2)+'.')
